...
import { DrawerDefault } from "./drawer";
  ...
  export function CardDefault({product}:CardDefaultProps ) {
    ...
    const WhatsAppButton = () => {
        ...
        const message = 'Hola!, Estoy interesado en este producto: ' + product?.title; // Replace with your message
        ...
        <>
            <Card className="mt-6 w-96">
                ...
                <div className="flex flex-row gap-2">
                    ...
                    <Button onClick={WhatsAppButton} variant="outlined">
            ...
            <DrawerDefault open={open} closeDrawer={closeDrawer} product={product}/>
        </>
