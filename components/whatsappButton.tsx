...
const WhatsAppButton = ({ number, msg }: WhatsAppButtonProps) => {
    // Define the phone number and message
    const phoneNumber = number; // Replace with the actual phone number in international format
    const message = msg; // Replace with your message
